...
@php
if(session()->get('page') != 'follower' ){
    session()->put('page', 'follower');
    ...
    <div class="name-section">
        <div class="row">
            <div class="col-12 col-lg-4 col-xl-3 profile-image">
                <img loading="lazy" src="http://localhost/wexprez_api/uploads/user_profile/{{$myProfile->profile_image}}" alt="{{$myProfile->full_name}}">
            </div>
    ...
    <div class="acitivity-section">
        <nav class="navbar navbar-expand">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="{{route('profileFollower', $myProfile->user_name)}}">Follower</a>
                </li>
        ...
        <div class="activity-form">
            <form method="post" id="activity-form" enctype="multipart/form-data">
                ...
                <div class="input-area">
                    <img loading="lazy" src="{{asset('')}}{{$profile->profile_image}}" alt="{{$profile->full_name}}">
            ...
            <div class="col-6">
                <div class="activity-filter">
                    <div class="activity-filter-div">
                        <button class="post-filter" id="All" value="All" onclick="activityFilter(this)"><img loading="lazy"
                                src="{{asset('')}}images/emotion/all.png"></button>
                    </div>
                    <div class="activity-filter-div">
                        <button class="post-filter" id="Positive" value="Positive" onclick="activityFilter(this)"><img loading="lazy"
                                src="{{asset('')}}images/emotion/positive.png"></button>
                    </div>
                    <div class="activity-filter-div">
                        <button class="post-filter" id="Negative" value="Negative" onclick="activityFilter(this)"><img loading="lazy"
                                src="{{asset('')}}images/emotion/negative.png"></button>
                    </div>
                    <div class="activity-filter-div">
                        <button class="post-filter" id="Neutral" value="Neutral" onclick="activityFilter(this)"><img loading="lazy"
        ...
        <div class="activity-feed" id="activity-feed">
            ...
            @php $emotion = session()->get('emotion');
            ...
            <div class="activity-card">
                ...
                <div class="activity-meta" id="activity-meta-{{$activity->id}}">
                    ...
                    <div class="share" id="share-{{$activity->id}}"><button data-id="{{$activity->id}}"
                            onclick="share(this)"> <i class="fa-solid fa-share"></i> Share</button></div>
