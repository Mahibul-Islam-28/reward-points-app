    ...
    <section class="profile-content">
        ...
        <nav class="navbar navbar-expand profile-subnav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="{{route('profileImage', $myProfile->user_name)}}">Change Profile
                        Picture</a>
                </li>
                <li class="nav-item">
        ...
        <div class="row my-5">
            ...
            <div class="col-xl-4 col-12 text-center" style="padding:75px;">
            ...
            <div class="col-xl-4 col-12" style="padding:75px; background-color: #333">
    ...
    $(document).ready(function () {
        ...
        $('.crop_image').click(function (event) {
            $image_crop.croppie('result', {
                ...
                $.ajax({
                    url: '{{ route("profileImageUpload", $myProfile->user_name) }}',
                    type: 'post',
                    data: {
                        image: response,
                        _token: _token
                    ...
                    success: function (data) {
                        ...
                        $('#after-upload').html(
                            "Profile Picute has been Uploaded!");
                    }
                });
            });
        });
