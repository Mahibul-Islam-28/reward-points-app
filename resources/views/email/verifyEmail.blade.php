...
<body>
    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <img class="img-fluid" src="https://www.wexprez.com/images/fb-meta.png" width="100%"
                    height="300px">
                <p class="card-text">
                    <p style="color: black;"><b>Dear Wexprez User,</b></p>
                    <p style="color: black;"><a href="{{$url}}" class="link">Click here</a> to verify your email.</p>
                </p>
                <p>
                    Thanks, <br>
                    On behalf of<br>
