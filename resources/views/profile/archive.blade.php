...
@php
if(session()->get('page') != 'archive' ){
    session()->put('page', 'archive');
    ...
    <div class="acitivity-section">
        <nav class="navbar navbar-expand">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="{{route('profileArchive', $myProfile->user_name)}}">Archive</a>
                </li>
                @endif
                <li class="nav-item">
                ...
                <div class="activity-filter">
                    <div class="activity-filter-div">
                        <button class="post-filter" id="All" value="All" onclick="activityFilter(this)"><img
                                loading="lazy" src="{{asset('')}}images/emotion/all.png"></button>
                    </div>
                    <div class="activity-filter-div">
                        <button class="post-filter" id="Positive" value="Positive" onclick="activityFilter(this)"><img
                                loading="lazy" src="{{asset('')}}images/emotion/positive.png"></button>
                    </div>
                    <div class="activity-filter-div">
                        <button class="post-filter" id="Negative" value="Negative" onclick="activityFilter(this)"><img
                                loading="lazy" src="{{asset('')}}images/emotion/negative.png"></button>
                    </div>
                    <div class="activity-filter-div">
                        <button class="post-filter" id="Neutral" value="Neutral" onclick="activityFilter(this)"><img
                                loading="lazy" src="{{asset('')}}images/emotion/neutral.png"></button>
                    </div>
        ...
        <div class="activity-feed" id="activity-feed">
            ...
            <div class="activity-card">
                ...
                <div class="activity-top">
                    <div class="profile-image">
                        <img loading="lazy" src="{{asset('')}}{{$activity->profile_image}}"
                ...
                <div class="activity-meta" id="activity-meta-{{$activity->id}}">
                    ...
                    <div class="delete" id="show-{{$activity->id}}"><button data-id="{{$activity->id}}"
                            onclick="activityShow(this)">Unhide</button></div>
